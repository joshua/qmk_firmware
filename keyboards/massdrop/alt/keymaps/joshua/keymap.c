...
#define C_SCREEN_SAVER LCTL(LALT(LSFT(LGUI(KC_BSLS))))
#define C_MUTIFY LCTL(LALT(LSFT(LGUI(KC_M))))
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = LAYOUT(
        ...
        SHRUG,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_PGUP, \
...
qk_tap_dance_action_t tap_dance_actions[] = {
    [TD_MUTE_LOCK] = ACTION_TAP_DANCE_DOUBLE(C_MUTIFY, C_SCREEN_SAVER),
};
